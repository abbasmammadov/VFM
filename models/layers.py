...
try:
    ...
    fa3_func = None
if fa2_func is None and fa3_func is None:
    print("Warning: Flash Attention is not available. Make sure to install it for fast / better performance.")
elif fa2_func is not None and fa3_func is None:
    print("Warning: Flash Attention v3 is not available. We will only be able to use Flash Attention v2.")
