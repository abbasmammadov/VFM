...
class DMFT(nn.Module):
    def __init__(
        ...
        **block_kwargs # fused_attn, qk_norm, post_ln
        ...
        self.out_channels = in_channels * 2 if pretrained_sigma else in_channels
        self.pretrained_sigma = pretrained_sigma
    ...
    def forward(self, x, t, r, y, return_logvar: bool = False):
        ...
        x = self.unpatchify(x)
        # logvar = None
        if self.pretrained_sigma: # ignore the sigma part if pretrained model had this inherently
